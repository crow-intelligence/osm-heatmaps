        ...
        for j in range(m):
            ...
            if z > 0.001:
                ...
                T = Matrix.Translation(
                    Vector((width * (x - 0.5), width * (y - 0.5), bar_height / 2))
                )
...
if __name__ == "__main__":
    # Settings
    iso_a2, tag_key, tag_value = "HU", "building", "industrial"
    # res_x, res_y = 768, 432
    # res_x, res_y =  600, 600
    # res_x, res_y =  640, 480
    # res_x, res_y =  640, 360
    ...
    if os.path.exists(filepath):
        ...
        points, names = utils_osm.overpass_load_points(iso_a2, tag_key, tag_value)
